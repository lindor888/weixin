...
<head>
    ...
    <script src="/weixin-studio/js/wenbenmaterial/wenbenMaterial.js" type="text/javascript"></script>
  </head>
  <body>
	<div id="" style="width: 90%; padding-left: 10%; margin-top: 10px;">
		...
		<form id="TextInfFrom">
			素材名称:&nbsp;&nbsp;
			<s:textfield id="textMaterialName"></s:textfield>
			&nbsp;&nbsp;&nbsp; 素材状态:
			<s:select list="#{'':'全部','1':'启用','0':'停用'}"
				cssStyle="width:150px" id="zhuangtai"></s:select>
			<br />
			<br /> 关联关键字:
			<s:textfield id="kwordname"></s:textfield>
			&nbsp;&nbsp;&nbsp; <a class='easyui-linkbutton l-btn l-btn-plain'
				onclick="teQuery()" style="margin-left: 250px;"><span
				class='l-btn-text icon-search' style='padding-left: 20px;'>查询</span></a>
		</form>

		<div style="height: 20px;"></div>

	</div>
	<table id="wenbenMaterial"></table>
  </body>
</html>
