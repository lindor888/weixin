...
<head>
    ...
    <script src="/weixin-studio/js/epgcomment/epgcomment.js" type="text/javascript"></script>
...
<div id="" style="width:90%;padding-left: 10%; margin-top: 10px;">
	<div style="height: 10px;"></div>
	 <form id="">
		...
		评论日期：&nbsp;&nbsp;<s:textfield theme="simple"  id="comment_time" name="comment_time" maxLength="500"  class="Wdate" cssStyle="width: 182px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readonly:true,isShowClear:true})" ></s:textfield>
		<a class='easyui-linkbutton l-btn l-btn-plain' onclick="query1()" style="margin-left: 250px;"><span class='l-btn-text icon-search' style='padding-left: 20px;'>查询</span></a>
	</form> 
</div>
