...
<body>
	...
	<div style="padding-left: 50px;">
		...
		<table border="0" cellspacing="0">
		 ...
		 -->
			...
			<a class='easyui-linkbutton l-btn l-btn-plain' onclick="fanhui()" style="margin-left:80px;">
	...
	var desc10=$.trim($('#desc10').val());
		...
		$.ajax({   
				url:'/weixin-studio/follower/tuwentuiFollower?random='+Math.round(Math.random()*10000),
		        type: 'POST',   
		        async: false,
		        data:  param,
		       dataType: 'json',  
