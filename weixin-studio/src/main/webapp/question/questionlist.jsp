...
$(function(){
			 ...
			 $.ajax({
				url:"/weixin-studio/question/listQuestion?id="+id,
				dataType:"json",
				type:"get",
				async:false,
				...
				for (var i=0; i<data.rows.length; i++) {
					...
					html += '<tr>';
					html +='<td width="65%" style="text-align:center"><span name="black" style="word-break:break-all;word-wrap:break-word;">'+row.questionname+'</span></td>';
					html +='<td width="10%" ><a href="/weixin-studio/question/listoption.jsp?id='+row.questionid+'">详情</a></td>';
				    html +='<td width="40%" ><a href="/weixin-studio/question/questionStat.jsp?id='+row.questionid+'">查看答题结果</a>|<a href="/weixin-studio/question/updateoption.jsp?id='+row.questionid+'">选项修改</a></td>';
					html += '</tr>';
				}
				}
				$("#conten").html(html);
...
<div id="maincontent">
  <div class="wrap">
    <div class="crumbs">当前位置 &gt;&gt; 问题列表</div>
