...
$(function(){
			 ...
			 $.ajax({
				...
				for (var i=0; i<data.rows.length; i++) {
					...
					html += '<tr>';
					html +='<td width="65%" style="text-align:center"><span name="black" style="word-break:break-all;word-wrap:break-word;"><a href="">'+row.opt+'</a></span></td>';
					html +='<td width="10%" ><a href="">'+row.option_total+'</a></td>';
...
<div id="maincontent">
  <div class="wrap">
    <div class="crumbs">当前位置 &gt;&gt; 选项详情</div>
