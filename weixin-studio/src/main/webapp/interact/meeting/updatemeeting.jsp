...
function add(){
		...
		function update(){
			...
			if(meetingtheme=='' || meetingdata=='' || starttime=='' || meetingaddress==''){
				alert('您有必填项未填!');
				return;
			}
			$.ajax({
				url : '/weixin-studio/interact/modifymeetingInteract',
				type : 'post',
				async : false,
				data : {'meetingAgenda.meetingid':meetingid,'meetingAgenda.meetingtheme':meetingtheme,'meetingAgenda.meetingdata':meetingdata,'meetingAgenda.starttime':starttime,'meetingAgenda.meetingaddress':meetingaddress},
				success : function(data){
					if(data.msg=='success'){
						alert('修改成功');
						window.parent.closeColorBox(false);
	...
	<div style="padding-left: 30px; padding-top: 5px">
		<form action="" name="editEpg" id="editEpg">
			<div style="display: none;">
				<s:textfield id="meetingid" name="meetingAgenda.meetingid"></s:textfield>
			</div>
		<table style="padding-left: 30px; width: 80%">
			<tr>
				<td><span style="color: #CC3300">*</span>&nbsp;会议主题：</td>
				<td><s:textfield theme="simple"  name="meetingAgenda.meetingtheme" id="meetingtheme" cssStyle="width: 250px;" maxLength="200"></s:textfield>
				</td>
			</tr>
			<tr>
				<td><span style="color: #CC3300">*</span>&nbsp;会议日期：</td>
				<td><s:textfield theme="simple"  id="meetingdata" maxLength="500"  name="meetingAgenda.meetingdata" class="text1 Wdate startDate" cssStyle="width: 182px;" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" >
			...
			<tr>
				...
				<td><s:textfield theme="simple"  name="meetingAgenda.starttime" id="starttime" cssStyle="width: 250px;" maxLength="200"></s:textfield>
				</td>
			</tr>
			<tr>
				<td><span style="color: #CC3300">*</span>&nbsp;会议地点：</td>
				<td><s:textfield theme="simple"   name="meetingAgenda.meetingaddress" id="meetingaddress" maxLength="500" cssStyle="width: 250px;"></s:textfield>
				</td>
			</tr>
