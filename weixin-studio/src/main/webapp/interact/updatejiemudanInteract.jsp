...
<script>
	...
	function updateInteract(){
		...
		var programme_save_id =  window.location.href.split("programme_save_id=")[1];
		...
		$.ajax({
			url : '/weixin-studio/interact/updatejiemudanInteract',
			type : 'post',
			async : false,
			data : {'bean.openId':openId,'bean.programmeId':programme_save_id,'bean.nickname':nickname,'bean.sex':sex,'bean.country':country,'bean.province':province,
