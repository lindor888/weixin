	...
	function addInteract(){
		...
		$.ajax({
			...
			data : {'bean.openId':openId,'bean.nickname':nickname,'bean.sex':sex,'bean.country':country,'bean.province':province,
				'bean.city':city,'bean.headimgurl':imageUrl1,'bean.content':content,'bean.image':image,'bean.updateTimeStr':updateTimeStr,'bean.type':type},
...
<div class="h" >
	...
	<div style="padding-left:500px;"><ul class="button_1" >
			<li><span onclick="addInteract()">保存</span></li>
