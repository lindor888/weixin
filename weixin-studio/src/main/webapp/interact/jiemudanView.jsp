...
<head>
   ...
   <script src="/weixin-studio/style/js/jquery-1.4.2.min.js" type="text/javascript"></script>
    ...
    <script src="/weixin-studio/interact/interactView.js" type="text/javascript"></script>
...
<div id="" style="width:90%;padding-left: 10%; margin-top: 10px;">
	...
	<a class='easyui-linkbutton l-btn l-btn-plain' onclick="selectByPagebianji()" ><span class='l-btn-text icon-search' style='padding-left: 20px;'>查询</span></a>
