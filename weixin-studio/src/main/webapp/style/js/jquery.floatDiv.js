...
jQuery.fn.floatdiv=function(location){
	...
	return this.each(function(){
		...
		if(location==undefined || location.constructor == String){
			...
			switch(location){
				...
				case("middletop"):
					var l=0;//居左
					l=windowWidth/2-$(this).width()/2;
					loc={left:Math.round(l)+"px",top:"0px"};
					break;
				case("bottommiddle"):
					loc={left:"0px",bottom:"0px",right:"0px","margin-left":"auto","margin-right":"auto"};
					break;
				default://默认为右下角
					loc={right:"0px",bottom:"0px"};
					break;
		...
		$(this).css("z-index","9000").css(loc).css("position","fixed");
		if(isIE6){
