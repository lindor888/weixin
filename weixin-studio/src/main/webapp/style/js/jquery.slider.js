    ...
    $.extend($.fn, {
        ...
        jSlider: function(setting) {
            ...
            var slide = {
                ...
                drop: function(e) {
                	$(this).unbind('mousemove', slide.drag).unbind('mouseup', slide.drop);
            ...
            if (ps.enable) {
                ...
                slider.bind('mousedown', function(e) {
                    ...
                    $(this).bind('mousemove', d, slide.drag).bind('mouseup', d, slide.drop).bind('mouseout', d, slide.drop);               
                });
            }
        ...
        getSliderValue: function(){
        	return parseInt(slider.css('left')) / ps.limited.max;
        }
    });
})(jQuery);